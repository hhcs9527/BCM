...
class DMPHN_1_2_4_BRRALL(nn.Module):
    def __init__(self, opt):
        super().__init__()
        compression_ratio = 1
        self.encoder_lv3 = BRR_Encoder(opt, level = 3)  
        self.encoder_lv2 = BRR_Encoder(opt, level = 2)  
        self.encoder_lv1 = BRR_Encoder(opt, level = 1) 

        self.decoder_lv3 = BRR_Decoder(opt)
...
class DMPHN_1_2_4_8_BRRALL(nn.Module):
    def __init__(self, opt):
        super().__init__()
        compression_ratio = 1
        self.encoder_lv4 = BRR_Encoder(opt, level = 4) 
        self.encoder_lv3 = BRR_Encoder(opt, level = 3) 
        self.encoder_lv2 = BRR_Encoder(opt, level = 2) 
        self.encoder_lv1 = BRR_Encoder(opt, level = 1) 

        self.decoder_lv4 = BRR_Decoder(opt)
        self.decoder_lv3 = BRR_Decoder(opt)
        self.decoder_lv2 = BRR_Decoder(opt)   
        self.decoder_lv1 = BRR_Decoder(opt)
        self.num_split = opt.per_pix_kernel ** 2
